...
public class AiAnalysisResultVo {
    ...
    /**
     * AI痕迹分析维度（基于数学公式计算，共6个维度）
     * 维度名有六个：言語的困惑度、句式変化幅、意味分布エントロピー、推論複雑性、感情起伏度、構造とテンプレート使用傾向。
     * 每个AiDimensionVo对象包括维度名、该维度名下AI生成痕迹的级别（0.0-10.0，保留1位小数，分数越高越接近人类写作）、AI生成痕迹在该维度的解释说明（尽量2句话的篇幅）
     */
